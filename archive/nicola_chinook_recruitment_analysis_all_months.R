...
d$smolt_age_3_survival_c <- as.numeric(scale(d$smolt_age3_survival))
# Proportion wild
...
dat <- list(
  ...
  SW = d$wild_spawners,
  SH = d$hatch_spawners,
  ocean_surv = d$smolt_age_3_survival_c,
  #jan_mean_flow = d$jan_mean_flow,
  #feb_mean_flow = d$feb_mean_flow,
  #mar_mean_flow = d$mar_mean_flow,
...
ppd <- post[, grep("pp_R", colnames(post4))]
# for extra flow vars
