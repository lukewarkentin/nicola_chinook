...
transformed parameters {
  ...
  mu = alpha * (SW+SH) .* exp(-betaW * SW - betaH * SH + OSA * b1 + max_flow_fall * b2 + mean_flow_aug * b3); // model predicting log_r_per_s from alpha and beta and ocean survival anomaly, max winter flow, and drought index
  }
