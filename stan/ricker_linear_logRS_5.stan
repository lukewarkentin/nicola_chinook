...
transformed parameters {
  ...
  pred_log_RS = lnalpha - betaW * Sw -betaH * Sh + b1 * ocean_surv + b2 * aug_mean_flow + b5 * aug_mean_flow_rear ; // model predicting recruits from alpha and beta and covariates
