...
transformed parameters {
  ...
  pred_log_RS = lnalpha - betaW * Sw -betaH * Sh + b1 * ocean_surv + b2 * aug_mean_flow + b3 * sep_dec_max_flow
  + b4 * ice_days; // model predicting recruits from alpha and beta and covariates
